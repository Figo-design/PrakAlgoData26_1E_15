...
public class BinaryTree15 {
    ...
    private Node15 addRekursif(Node15 current, Mahasiswa15 mahasiswa) {
        if (current == null) {
    ...
    public void printMahasiswaIPK(double ipkBatas) {
        printMahasiswaIPK(root, ipkBatas);
    }

    private void printMahasiswaIPK(Node15 node, double ipkBatas) {
        if (node != null) {

            printMahasiswaIPK(node.left, ipkBatas);

            if (node.mahasiswa.ipk > ipkBatas) {
                node.mahasiswa.tampilInformasi();
            }

            printMahasiswaIPK(node.right, ipkBatas);
        }
    }
}
